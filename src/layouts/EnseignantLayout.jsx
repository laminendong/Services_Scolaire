...
import { LogOut, Menu, X, LayoutDashboard, BookOpen, ClipboardList, Calendar } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <button onClick={() => setOpen(true)}
        className="lg:hidden fixed top-3.5 left-4 z-[60] w-10 h-10 rounded-xl bg-indigo-900 text-white flex items-center justify-center shadow-lg"
