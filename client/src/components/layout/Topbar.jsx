...
export default function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-40 h-[66px] flex items-center gap-4 pl-16 pr-4 lg:px-8 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
      {/* PAGE INFO */}
      <div>
      ...
      {/* SEARCH */}
      <div className="ml-auto hidden md:flex items-center gap-2 bg-gray-100 border border-gray-200 rounded-xl px-3.5 py-2 min-w-[230px] focus-within:border-blue-400 focus-within:bg-white focus-within:ring-2 focus-within:ring-blue-100 transition-all">
